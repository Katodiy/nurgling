...
public class BuildCupboard extends Bot {
    
    
    public BuildCupboard ( NGameUI gameUI ) {
        super ( gameUI );
        win_title = "BuildCupb";
        win_sz.y = 100;
        
        CraftCommand command = new CraftCommand();
        command.command = new char[]{ 'b', 'c', 'u' };
        ...
        command.ing_count.put(board,8);
        ///Добавление цикла в действия бота
        runActions.add ( new Build( build_area, "cupboard", command ) );
    }

...
public class BarkCollector extends Bot {
    
    
    public BarkCollector ( NGameUI gameUI ) {
        super ( gameUI );
        win_title = "BarkCollection";
        win_sz.y = 100;
        
        
        ///Добавление цикла в действия бота
        runActions.add ( new TreeItemsCollection( tree_area , pile_area, new NAlias("bark"),"stockpile-bark", "Take") );
    }
    ...
    public void initAction ()
        ...
        int y = 0;
        window.add ( new Button ( window.buttons_size, "Trees for bark" ) {
            @Override
            public void click () {

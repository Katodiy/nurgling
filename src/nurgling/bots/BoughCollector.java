...
public class BoughCollector extends Bot {
    
    
    public BoughCollector ( NGameUI gameUI ) {
        super ( gameUI );
        win_title = "Bough Collection";
        win_sz.y = 100;
        
        
        ///Добавление цикла в действия бота
        runActions.add ( new TreeItemsCollection( tree_area , pile_area, new NAlias("bough"), "stockpile-bough",
                "Take" ) );
    }
